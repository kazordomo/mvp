			...
			<CenteredWrapper bigger>
				<div>
					{activeRatingOccasion ? (
						<div>
							<RatingInfo>
								Aktiv röstning: {activeRatingOccasion.opponents}
							</RatingInfo>
							<Button danger onClick={onCloseRating} customStyle={btnStyle}>
				...
				<div>
					<Input
						...
						show
					/>
					<Button onClick={onAddAdmin} customStyle={btnStyle} disabled={!admin}>
