...
export const findActive = createSelector(findAll, matches =>
	matches.find(match => match.active)
);

export const findRatings = createSelector(find, match => match.ratings);

export const findSortedRatings = createSelector(findRatings, ratings =>
	ratings
